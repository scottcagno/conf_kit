...
// watch config file, update data map every time file changes
...
// return updated map
func update(fpath string) map[string]interface{} {
	...
	// no err; create empty map placeholder
	var m map[string]interface{}
	// unmarshal b (json []byte) into map
...
// return true if file has been modified within n seconds, else return false
func changed(fpath string, n int64) bool {
	...
	// no err; eval and return wether file been modified within the last n seconds
